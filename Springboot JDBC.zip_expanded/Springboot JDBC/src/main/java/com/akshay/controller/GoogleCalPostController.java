...
@RestController("/login/postEvents")
public class GoogleCalPostController {

	private static final String APPLICATION_NAME = "Post Events Schedule";
	...
	@RequestMapping(value = "/login/postEvents", method = RequestMethod.GET)
	...
	@RequestMapping(value = "/login/postEvents", method = RequestMethod.GET, params = "code")
	public ResponseEntity<String> oauth2Callback(@RequestParam(value = "code") String code) {
	
		String eventResponse;
		String event_summary = "SAPHO MEETING";
		String event_location = "OSTRICH";
		String event_description = "SAPHO CONNECTORS ISSUE'S";
		String event_attendeees_email1 = "a@gmail.com";
		String event_attendeees_email2 = "b@gmail.com";
		...
		try {
			...
			EventAttendee[] attendees = new EventAttendee[] { new EventAttendee().setEmail(event_attendeees_email1),
					new EventAttendee().setEmail(event_attendeees_email2), };
			...
			FileWriter fw = new FileWriter(
					"C:\\JAVA\\SYNERGY.zip_expanded\\SYNERGY\\src\\main\\resources\\GoogleApiResponses\\CreatedEvents.json");
